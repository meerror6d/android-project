...
public class homepageadaptar extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homepafemodelList.get(position).getType()){
            case homepafemodel.BANNER_SLIDER:
                ...
                break;
            case homepafemodel.STRIP_ADD_SLIDER:
                String resource=homepafemodelList.get(position).getResource();
    ...
    public class stripaddbannerviewholdwer extends RecyclerView.ViewHolder{
        ...
        private void stripadd(String resource,String color ){
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.phone)).into(stripimage);
    ...
    public class gridproductviewholder extends RecyclerView.ViewHolder{
        ...
        private void setGridlayout(List<horizontalscrollmodel>horizontalscrollmodelList,String title){
            ...
            for(int x=0;x<4;x++){
                ...
                ImageView productImage=gridproductlayout.getChildAt(x).findViewById(R.id.phone);
                TextView producttitle=gridproductlayout.getChildAt(x).findViewById(R.id.phone_name);
                TextView productdescription=gridproductlayout.getChildAt(x).findViewById(R.id.ram);
                TextView productprice=gridproductlayout.getChildAt(x).findViewById(R.id.prize);


                Glide.with(itemView.getContext()).load(horizontalscrollmodelList.get(x).getProductimage()).apply(new RequestOptions().
                        placeholder(R.drawable.home)).into(productImage);

                //productImage.setImageResource(horizontalscrollmodelList.get(x).getProductimage());
                producttitle.setText(horizontalscrollmodelList.get(x).getProducttitle());
                productdescription.setText(horizontalscrollmodelList.get(x).getProductdescription());
                productprice.setText(horizontalscrollmodelList.get(x).getProductprice());
