...
import static com.Sornaly.gadgetstore.DeliveryActivity.SELECT_ADDRESS;
import static com.Sornaly.gadgetstore.MyAddressesActivity.refreshItem;
import static com.Sornaly.gadgetstore.ui.my_account.MyAccountFragment.MANAGE_ADDRESS;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.setdata(name,mobileNo,selected,flatNo,landmark,locality,city,alternateMobileNo,position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setdata(String name, String mobileNo, boolean selected, String flatNo, String landmark, String locality, String city, String state, final int position){
